...
//-----------------------------------------------------------------------------
/// Undoes a change in the text string of a t2dTextObject.
/// 
/// Usage:
...
public:
   ...
   void setOldText( t2dTextObject* textObject ) { mTextObject = textObject; mOldText.set( &mTextObject->getText() ); };
