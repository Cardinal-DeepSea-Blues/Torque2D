...
public:
   ...
   virtual bool onMouseMove(LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus)          { return false; };
   virtual bool onMouseDown(LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus)          { return false; };
   virtual bool onMouseUp(LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus)            { return false; };
   virtual bool onMouseDragged(LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus)       { return false; };
   virtual bool onRightMouseDown(LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus)     { return false; };
   virtual bool onRightMouseUp(LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus)       { return false; };
   virtual bool onRightMouseDragged(LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus)  { return false; };
   virtual bool onMiddleMouseDown(LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus)    { return false; };
   virtual bool onMiddleMouseUp(LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus)      { return false; };
   virtual bool onMiddleMouseDragged(LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus) { return false; };
   virtual bool onMouseWheelUp(LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus)       { return false; };
   virtual bool onMouseWheelDown(LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus)     { return false; };
   ...
   /// onRenderGraph is called by the edit window when this tool is active.
