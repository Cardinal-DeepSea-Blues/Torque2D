...
bool LevelBuilderPolyTool::onMouseMove( LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus )
{
...
bool LevelBuilderPolyTool::onRightMouseDown( LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus )
{
   if (!mSceneObject || (sceneWindow != mSceneWindow))
...
bool LevelBuilderPolyTool::onRightMouseDragged(LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus)
{
   if (!mSceneObject || (sceneWindow != mSceneWindow))
      return Parent::onRightMouseDown(sceneWindow, mouseStatus);
...
bool LevelBuilderPolyTool::onRightMouseUp(LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus)
{
...
bool LevelBuilderPolyTool::onMouseDown( LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus )
{
...
bool LevelBuilderPolyTool::onMouseUp(LevelBuilderSceneWindow* sceneWindow, const t2dEditMouseStatus &mouseStatus)
{
   if (!mSceneObject || (sceneWindow != mSceneWindow))
      return false;
...
void LevelBuilderPolyTool::setPolyPrimitive( U32 polyVertexCount )
{
   ...
   if ( polyVertexCount > t2dPhysics::MAX_COLLISION_POLY_VERTEX )
   {
      Con::warnf("LevelBuilderPolyTool::setPolyPrimitive() - Cannot generate a %d edged collision polygon.  Maximum is %d!", polyVertexCount, t2dPhysics::MAX_COLLISION_POLY_VERTEX);
      return;
   }
